...
function showTutorialPDF(iaId) {
    ...
    if (ia) {
        // Mapear IDs para PDFs existentes
        const pdfMap = {
            9: "Tutorial de Arduino IDE 2.0.pdf",
            11: "Tutorial de Khan Academy Khanmigo.pdf",
            12: "Tutorial de Wolfram Alpha.pdf",
            13: "Tutorial de GeoGebra.pdf",
            14: "Tutorial de Scratch for Arduino.pdf",
            6: "Tutorial de Tinkercad Circuits.pdf",
            18: "Tutorial de Wokwi Arduino Simulator.pdf",
            2: "Tutorial de ChatGPT.pdf",
            3: "Tutorial de Replit AI.pdf",
            1: "Tutorial de GitHub Copilot.pdf",
            19: "Tutorial de Photomath.pdf"
        };
        
        const pdfUrl = pdfMap[iaId] || `Tutorial de ${ia.name}.pdf`;
